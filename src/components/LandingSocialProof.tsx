      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Properties Analyzed</p>
          </div>
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-bold text-success mb-2">
              <AnimatedCounter end={15} suffix="M+" prefix="$" />
            </div>
            <p className="text-muted-foreground">Tax Benefits Identified</p>
          </div>
          <div className="text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="border-destructive/20 bg-destructive/5">
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-4 text-destructive">Without Property Pro</h3>
          ...
          <Card className="border-success/20 bg-success/5">
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-4 text-success">With Property Pro</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
