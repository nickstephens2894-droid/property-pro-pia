        ...
        <div className="text-center max-w-6xl mx-auto">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight mb-8 text-shadow">
              ...
              <span className="gradient-text animate-glow animate-pulse">
                Australian Property
              </span>
            </h1>
          </div>
          ...
          <div className="animate-fade-in animation-delay-300">
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
              Professional-grade property investment analysis with Australian
              tax calculations, multi-investor modeling, and 40-year
              projections. For individual investors and financial advisors.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-20 animate-slide-in-right animation-delay-600">
            {user ? (
              <Button
                size="lg"
                asChild
                className="min-w-[260px] h-14 magnetic-hover bg-blue-600 hover:bg-blue-700 text-white border-2 border-blue-600 hover:border-blue-700 text-lg font-semibold shadow-lg hover:shadow-xl"
              >
                <Link to="/instances">
              ...
              <>
                <Button
                  size="lg"
                  asChild
                  className="min-w-[260px] h-14 magnetic-hover bg-gradient-to-r from-primary to-chart-4 hover:from-chart-4 hover:to-primary transition-all duration-500 text-lg font-semibold shadow-lg hover:shadow-xl"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="min-w-[260px] h-14 magnetic-hover glass border-2 border-primary/30 hover:border-primary/60 text-lg font-semibold"
                >
                  <Link to="/auth">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mt-16 sm:mt-20 lg:mt-24 max-w-4xl mx-auto animate-scale-in animation-delay-900">
            <div className="group flex flex-col items-center p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl glass magnetic-hover border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-3 sm:mb-4 gradient-text text-center">
                Australian Tax Engine
              </h3>
              <p className="text-muted-foreground text-center leading-relaxed text-sm sm:text-base">
                Accurate Div 40/43 depreciation, stamp duty, and Medicare levy
                calculations
              </p>
            </div>
            ...
            <div className="group flex flex-col items-center p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl glass magnetic-hover border-2 border-success/30 hover:border-success/50 transition-all duration-500 hover:shadow-2xl hover:shadow-success/20">
              ...
              <p className="text-muted-foreground text-center leading-relaxed text-sm sm:text-base">
                Long-term analysis with inflation, CPI adjustments, and market
                cycles
              </p>
            </div>
          </div>
