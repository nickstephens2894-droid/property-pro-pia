...
export default function Investors() {
  const { investors, loading, addInvestor, updateInvestor, removeInvestor } =
    useRepo();

  console.log(
    "Investors page render - loading:",
    loading,
    "investors:",
    investors
  );
        ...
        <form onSubmit={handleInvestorSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Income from other sources (rental, dividends, etc.)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInvestorForm({
                    ...investorForm,
                    nonTaxableIncome: Number(e.target.value),
                  })
                }
                placeholder="5000"
              />
            ...
            <div className="flex items-center justify-between py-2">
              <div className="space-y-1">
                <Label
                  htmlFor="hasMedicareLevy"
                  className="text-sm font-medium"
                >
                  Medicare Levy
                </Label>
                <p className="text-sm text-muted-foreground">
                  Is this investor subject to Medicare levy?
                </p>
              </div>
              <Switch
                id="hasMedicareLevy"
                ...
                onCheckedChange={(checked) =>
                  setInvestorForm({ ...investorForm, hasMedicareLevy: checked })
                }
              />
            </div>
          </div>
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Get started by adding your first investor to track their
                financial details and investment contributions.
              </p>
              <div className="space-y-2">
                <Button onClick={openAddDialog}>
                  <Plus className="h-4 w-4 mr-1" />
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ...
                {formatCurrency(
                  investors.reduce(
                    (sum, inv) => sum + (inv.annualIncome || 0),
                    0
                  )
                )}
              </div>
